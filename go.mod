module github.com/nano-harness/nano-cloud

go 1.24.4

replace github.com/nano-harness/nano-agent => ../nano-agent
...
require (
	...
	github.com/sourcegraph/zoekt v0.0.0-20250815125100-74399876be40 // indirect
